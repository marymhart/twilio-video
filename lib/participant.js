...
class Participant extends EventEmitter {
  ...
  _handleTrackSignalingEvents() {
    const { _log: log, _clientTrackSwitchOffControl: clientTrackSwitchOffControl, _contentPreferencesMode: contentPreferencesMode, playPausedElementsIfNotBackgrounded, workaroundWebKitBug212780 } = this;
    const self = this;
    ...
    function trackSignalingSubscribed(signaling) {
      ...
      const options = { log, name, clientTrackSwitchOffControl, contentPreferencesMode, workaroundWebKitBug212780, playPausedElementsIfNotBackgrounded };
