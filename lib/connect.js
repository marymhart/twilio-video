...
function connect(token, options) {
  ...
  const playPausedElementsIfNotBackgrounded = options.playPausedElementsIfNotBackgrounded || null;
  const workaroundWebKitBug212780 = options.playPausedElementsIfNotBackgrounded || null;
