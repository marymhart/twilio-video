...
function connectParticipant(room, participantSignaling) {
  const { _log: log, _clientTrackSwitchOffControl: clientTrackSwitchOffControl, _contentPreferencesMode: contentPreferencesMode, workaroundWebKitBug212780, playPausedElementsIfNotBackgrounded } = room;
  const participant = new RemoteParticipant(participantSignaling, { log, clientTrackSwitchOffControl, contentPreferencesMode, workaroundWebKitBug212780, playPausedElementsIfNotBackgrounded });
